    ...
    <View style={styles.container}> 
      <View style={styles.containerForm}>
        ...
        <View style={styles.containerInputForm}>
          ...
          <InputText placeholder="meninodasilva@ALUNO.IFSP.EDU.BR" keyboardType="email-address" maxLength={70}/>
        </View>
        
        <View style={styles.containerInputForm}>
          <Text style={styles.descTextInp}>Sua senha:</Text>
          <InputText placeholder="wasdasd" 
          keyboardType="visible-password" maxLength={50}/>
